...
class RGCN(torch.nn.Module):
    def __init__(self, num_entities, num_relations, num_bases, dropout):
        ...
        self.relation_embedding = nn.Parameter(torch.Tensor(num_relations, 200))
...
class RGCN_pos(torch.nn.Module):
    def __init__(self, num_entities, num_relations, num_bases, dropout, pos_embedding=None):
        super(RGCN, self).__init__()
        ...
        self.conv1 = RGCNConv_pos(
            200, 200, num_relations * 2, num_bases=num_bases, pos_embedding=pos_embedding)
        self.conv2 = RGCNConv_pos(
            200, 200, num_relations * 2, num_bases=num_bases, pos_embedding=pos_embedding)
...
class RGCNConv_pos(MessagePassing):
    r"""The relational graph convolutional operator from the `"Modeling
    Relational Data with Graph Convolutional Networks"
    <https://arxiv.org/abs/1703.06103>`_ paper
